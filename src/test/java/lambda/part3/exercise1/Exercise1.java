...
public class Exercise1 {
    ...
    public void mapEmployeesToLengthOfTheirFullNames() {
        ...
        ToIntFunction<Employee> fullNameLengthExtractor = personExtractor.andThen(fullNameExtractor).andThen(stringLengthExtractor)::apply;

        employees.forEach(employee -> lengths.add(fullNameLengthExtractor.applyAsInt(employee)));
